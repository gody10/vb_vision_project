...
class MiniCourt():
    ...
    def __init__(self, frame):
        ...
        self.drawing_rectangle_height = 250
        self.buffer = 50
    ...
    def set_canvas_background_box_position(self, frame):
        ...
        # Fix the y-coordinates to be positive
    ...
    def set_court_drawing_keypoints(self):
        ...
        drawing_keypoints[5] = self.court_start_y + convert_meters_to_pixel_distance(constants.HALF_COURT_LINE_HEIGHT*2, constants.DOUBLE_LINE_WIDTH, self.court_drawing_width)
        # point 3
    ...
    def draw_background_rectangle(self, frame):
        ...
        # Draw the rectangle
        shapes = cv2.rectangle(shapes, (self.start_x, self.start_y), (self.end_x, self.end_y), (255, 255, 255), -1)
        out = frame.copy()
        alpha = 0.5
